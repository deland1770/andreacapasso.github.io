...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-top: 20px;">
  <div style="flex-shrink: 0;">
    <img src="/assets/images/investigator.jpg" alt="Foto do Investigador" style="width: 200px; border-radius: 10px;">
  </div>
  <div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px;">
  ...
  <div style="border: 1px solid #ccc; border-radius: 10px; padding: 10px; text-align: center;">
  <img src="{{ '/images/gabriel_barbosa.jpeg' | relative_url }}" alt="Gabriel Barbosa" style="width:150px; border-radius:50%;">
